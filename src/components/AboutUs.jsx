            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div className="relative">
                        <div className="bg-blue-100 rounded-3xl w-full aspect-square md:aspect-video flex items-center justify-center overflow-hidden shadow-2xl relative">
                            <img src="https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?auto=format&fit=crop&w=800&q=80" alt="Professional Technician" className="w-full h-full object-cover" />
                    ...
                    <div>
                        <h3 className="text-accent font-bold tracking-widest uppercase text-sm mb-4">About Mysore Home Appliances</h3>
                        ...
                        <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
                            <p>
                                At Mysore Home Appliances, we pride ourselves on being the go-to destination for high-quality, reliable, and affordable home appliance services. With a team of certified professionals and a commitment to excellence, we've served thousands of happy households across Mysore.
                            </p>
                            <p>
