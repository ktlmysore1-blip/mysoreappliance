...
const HeroBanner = ({ title, subtitle, defaultBrand, defaultAppliance }) => {
    return (
        <>
            {/* Hero Section */}
            <section className="relative bg-gradient-to-br from-primary via-blue-900 to-blue-950 text-white pt-24 pb-32 md:pt-32 md:pb-40 px-4 md:px-8 overflow-hidden">
            ...
            <section id="booking-section" className="relative z-10 -mt-20 px-4 md:px-8 mb-8">
